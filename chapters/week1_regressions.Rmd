...
Scatterplots are a useful tool when it comes to visualizing the relationship between a predictor and the response variable. The red line below is the regression line that OLS found to be the best fit.
